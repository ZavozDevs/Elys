...
def _is_no_git() -> bool:
    return os.environ.get("ELYS_NO_GIT") == "1"
...
def get_git_info() -> tuple[str, str]:
    ...
    return (
        hash_,
        f"https://github.com/ZavozDevs/Elys/commit/{hash_}" if hash_ else "",
    )


def get_git_hash() -> str | Literal[False]:
    """
    Get current Elys git hash
...
def get_commit_url() -> str:
    """
    Get current Elys git commit url
