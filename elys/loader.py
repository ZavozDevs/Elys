...
class InfiniteLoop:
    ...
    def stop(self, *args, **kwargs):
        with contextlib.suppress(AttributeError):
            _elys_client_id_logging_tag = copy.copy(  # noqa: F841
...
class Modules:
    ...
    def register_inline_stuff(self, instance: Module):
        for name, func in instance.elys_inline_handlers.copy().items():
        ...
        for name, func in instance.elys_callback_handlers.copy().items():
    ...
    def register_watchers(self, instance: Module):
        ...
        for _watcher in instance.elys_watchers.values():
